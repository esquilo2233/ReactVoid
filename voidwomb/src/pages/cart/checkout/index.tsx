    ...
    <div>
      <section className="bg-transparent py-16 antialiased dark:bg-gray-900">
        <form action="#" className="mx-auto max-w-6xl px-8 2xl:px-16">
          ...
          <div className="mt-12 sm:mt-16 lg:grid lg:grid-cols-2 lg:gap-16 xl:gap-20">
            <div className="space-y-12 lg:col-span-1 ml-4">
            ...
            <div className="mt-12 w-full space-y-12 sm:mt-16 lg:mt-0 lg:col-span-1 lg:col-start-2 lg:row-start-1 lg:row-end-3 mr-4">
              <div className="flow-root">
                <div className="-my-3 divide-y divide-gray-200 dark:divide-gray-800">
                  ...
                  <dl className="flex items-center justify-between gap-4 py-3">
                    <dt className="text-lg font-normal text-white dark:text-gray-400">Store Pickup</dt>  {/*Conectar com a base de dados do shipping*/}
                  ...
                  <dl className="flex items-center justify-between gap-4 py-3">
                    ...
                    <dd className="text-lg font-bold text-white dark:text-white">$8,392.00</dd> {/*Fazer a soma dos dois, o shipping e o total da encomenda sem portes*/}
                  </dl>
                </div>
              </div>
